                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" id="username" name="username" class="form-control" value="<?= isset($username) ? $username : "" ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating">
                                    ...
                                    <?php foreach ($listuser->result_array() as $row) : ?>
                                        <tr>
                                            <td class="td-actions text-center">
                                                <a href="<?= base_url() ?>dashboard/edituser?id=<?= $row['id'] ?>">
                                                    <button type="button" rel="tooltip" class="btn btn-success btn-round">
                                                        <i class="material-icons">edit</i>
                                                    </button>
                                                </a>
                                                <a href="<?= base_url() ?>dashboard/deleteuser?id=<?= $row['id'] ?>" onclick="if(!confirm('Apakah Anda ingin menghapus data ini?')){ return false; }">
                                            ...
                                            <td class="text-center"><?php if ($row['is_active'] == "1") { ?> Aktif <?php } else { ?>
                                                    Tidak Aktif
                                                <?php } ?></td>
                                            <td class="text-center"><?= date('d-m-Y  h:i:s a', $row['date_created']); ?> </td>
                                        </tr>
                                    <?php endforeach; ?>
                            </table>
                        </div>
